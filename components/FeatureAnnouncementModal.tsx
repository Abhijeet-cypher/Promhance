...
import { X, Sparkles, History, RefreshCw, LogIn, FlaskConical, ArrowRight } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* PromAI test-mode announcement */}
        <div className="rounded-xl border border-blue-500/20 bg-blue-500/[0.06] p-4 mb-6">
          <div className="flex items-center gap-2 mb-1.5">
            <FlaskConical className="w-4 h-4 text-blue-400" strokeWidth={1.75} />
            <span className="text-sm font-semibold text-white">
              Test your prompt before you use it
            </span>
          </div>
          <p className="text-xs text-[#a1a1a1] leading-relaxed mb-3">
            Run any prompt through PromAI and see exactly what it produces — so
            you know it gives you the result you want before you rely on it.
          </p>
          <Link
            href="/promai"
            onClick={dismiss}
